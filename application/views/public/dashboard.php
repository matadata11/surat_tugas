        ...
        <div class="card corona-gradient-card">
            <div class="card-body py-0 px-0 px-sm-3">
                <div class="row align-items-center">
                    <div class="col-4 col-sm-3 col-xl-2 p-2">
                        <img src="<?=__img('dashboard/step.svg');?>" class="gradient-corona-img img-fluid" alt="">
                    </div>
                    <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">Informasi</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="icon icon-box-danger">
                            <span class="mdi mdi-cart-off icon-item"></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="preview-list">
                        <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-sm-flex flex-grow">
                                <div class="flex-grow">
                                    <h6 class="preview-subject">Dwi Satria Pangestu</h6>
                                    <p class="text-muted mb-0">Pengecekan bangunan pada SMK Negeri 1 Simpang Kanan ...</p>
                                </div>
                                <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                    <p class="text-muted">15 minutes ago</p>
                                    <p class="text-muted mb-0">Kab. Aceh Singkil </p>
                                </div>
                            </div>
                        </div>
                    </div>
